 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Daniel Chen");
		  toPrint += p1.toString("dchen371");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Tyler");
		  toPrint += p2.toString("Tjones329");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alvan Price");
		  toPrint += p3.toString("Aprice43");
		  //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Alexander Guo");
          toPrint += p4.toString("aguo36");
